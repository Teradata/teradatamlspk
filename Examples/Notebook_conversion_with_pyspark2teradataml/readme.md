...
### Following artifacts are provided for Notebook conversion example:
...
>>> pyspark2teradataml("Predicting_House_Prices_Pyspark.ipynb")
Python Notebook 'Predicting_House_Prices_Pyspark.ipynb' converted to 'Predicting_House_Prices_Pyspark_tdmlspk.ipynb' successfully.
Notebook conversion report 'Predicting_House_Prices_Pyspark_tdmlspk.html' published successfully.
```
