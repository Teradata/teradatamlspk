...
### Following artifacts are provided for Script conversion example:
...
Python script 'Predicting_House_Prices_Pyspark.py' converted to 'Predicting_House_Prices_Pyspark_tdmlspk.py' successfully.
Script conversion report 'Predicting_House_Prices_Pyspark_tdmlspk.html' published successfully.
```
